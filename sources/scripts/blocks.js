...
{
    p: [[0, 0, 2.5], [3, 1, 4.5],[4, 2.3, 5.5],[6.5,2.3,8],[8, 1.2, 8.4],[9, 0.8, 10],[9,2.3,10.5],[6,0,12]],
    d: [[6.8, 0.3], [7.1, 0.3], [7.4, 0.3], [9.1, 2.7], [9.3, 2.7], [9.5, 2.7], [9.7, 2.7], [9.9, 2.7], [10.1, 2.7], [10.3, 2.7]],
    s: [[6.5,2.3,8], [9,0,11]]
},
{
    p: [[0, 0, 2.5], [3, 1, 5],[4, 2.3, 10],[5,0,6.5],[7,0,12]],
    d: [[6.8, 2.5], [7.1, 2.5], [7.4, 2.5], [7.7, 2.5], [8, 2.5], [8.3, 2.5], [9.5, 0.2], [9.8, 0.2], [10.1, 0.2]],
    s: [[0.8, 0, 1.3],[5, 0, 5.5],[5, 2.3, 6],[8, 0, 9], [9, 2.3, 10]]
},
{
    p: [[0, 0, 1], [2.5, 0, 4],[4, 1.3,9],[5,0,5.5],[6.5,0,11]],
    d: [[4.2, 0.7], [4.5, 0.8], [4.8, 0.7], [6.8, 0.2], [7.1, 0.2], [7.4, 0.2], [7.7, 0.2], [8, 0.2], [8.3, 0.2]],
    s: [[5, 1.3, 6],[8.8, 0, 10]]
},
{
