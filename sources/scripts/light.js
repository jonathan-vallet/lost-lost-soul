...
/**
 * Adds a filter over 
 * @param gameDuration int - time since game starts, to decre&se light over time 
 */
...
console.log(lightRadius, ligthBritghness)
    ...
    let blurGradient = context.createRadialGradient(x, player.y, 0, x, player.y, lightRadius);
